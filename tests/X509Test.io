...
X509Test := UnitTest clone do(
	...
	serverCert := Directory currentWorkingDirectory .. "/tests/server/dtls.pem"
	serverKey := Directory currentWorkingDirectory .. "/tests/server/dtls.key"
	clientCert := Directory currentWorkingDirectory .. "/tests/client/dtlsc.pem"
	clientKey := Directory currentWorkingDirectory .. "/tests/client/dtlsc.key"
	revokeClientCRL := Directory currentWorkingDirectory .. "/tests/revokeClient.crl"
	revokeServerCRL := Directory currentWorkingDirectory .. "/tests/revokeServer.crl"
	ca := Directory currentWorkingDirectory .. "/tests/server/dtlsCA.pem"
